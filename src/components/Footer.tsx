        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-lg">QuickFix</span>
            </div>
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              <a href="#services" className="block text-primary-foreground/70 hover:text-primary transition-colors">Services</a>
              <a href="#common-fixes" className="block text-primary-foreground/70 hover:text-primary transition-colors">Common Fixes</a>
              <a href="#locations" className="block text-primary-foreground/70 hover:text-primary transition-colors">Locations</a>
              <a href="#faq" className="block text-primary-foreground/70 hover:text-primary transition-colors">FAQ</a>
              <a href="#book" className="block text-primary-foreground/70 hover:text-primary transition-colors">Book a Repair</a>
            </nav>
          </div>
        </div>
