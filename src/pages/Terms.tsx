    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container max-w-3xl py-16 px-4">
        ...
        <div className="prose prose-sm text-muted-foreground space-y-8">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground">6. Pickup and Delivery</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground">7. Same-Day Priority</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground">8. Your Device</h2>
